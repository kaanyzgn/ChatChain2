...
class Chat extends Component {
    ...
    render() {
        return (
        <body>
        <div><style> </style><img src={chatPng} width="50" height="50" ></img></div>
            <div class="block-container">
                <div class="row">         
                    ...
                    <div class="col-5 right-block">
                        ...
                        <p class="blocks">Number of blocks: { this.state.nbBlocks }</p>
                        <p class="blocks">Last transaction gas: { this.state.lastGas }</p>
                        <div class="sender-block blockchain-block">
                            <p><b>Sender wallet:</b></p>
                            <p>{ this.state.account }</p>
                            <p><b>Number of transactions: </b>{ this.state.accountNbTransactions } </p>
    
                            <p><b>Wallet balance: </b>{ this.state.accountBalance } ETH</p>
                        </div>
                        <div class="recip-block blockchain-block">
                            <p><b>Reciever wallet:</b></p>
                            <p>{ this.state.otherAccount }</p>
                            <p><b>Number of transactions: </b>{ this.state.otherAccountNbTransactions }</p>
                            <p><b>Wallet balance: </b>{ this.state.otherAccountBalance } ETH</p>
                        </div>
